...
<div class="site-info">
	...
	<span class="footer-info-right">
		<?php echo esc_html_e(' | Theme by', 'gutenshop') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'gutenshop'); ?>"><?php echo esc_html_e(' SuperbThemes WordPress Themes', 'gutenshop') ?></a>
	</span>
